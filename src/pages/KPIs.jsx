  ...
  return (
    <>
      ...
      <Grid container spacing={2} sx={{ mb: 2 }}>
        <Grid item xs={12} md={3}><StatTile title="Task Completion Rate" value="80%" /></Grid>
        <Grid item xs={12} md={3}><StatTile title="Average Resolution Time" value="6.5 h" /></Grid>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
          <SectionCard title="Gráfica: % de tareas completadas por sprint">
        ...
        <Grid item xs={12} md={6}>
          <SectionCard title="Gráfica: Horas reales vs planificadas">
            <div style={{ width:"100%", height:260 }}>
              <ResponsiveContainer>
                <LineChart data={b}>
                  <CartesianGrid strokeDasharray="3 3" />
